        ...
        <header id="header" class="d-flex align-items-center user-select-none">
            ...
            >
                ...
                <nav id="navbar" class="navbar">
                    <a class="nav-link" href="{{ route('landingpage','#info') }}" id="link1"
                        ><button
                            class="
                                btn
                                button
                ...
                <div class="container">
                    ...
                    >
                        ...
                        <ol>
                            ...
                            <li><a href="{{ route('landingpage','#info') }}">Informasi</a></li>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-5">
                            <div
                                ...
                                "
                            >
                                <h2>Mencari jati diri</h2>
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam error, optio nobis facilis ea totam deleniti eligendi accusamus voluptates animi voluptatum maxime omnis beatae, nesciunt veniam! Architecto, quaerat. Explicabo ex architecto cum rem possimus natus odit quaerat qui quae, amet totam perferendis sapiente ad dolor unde, velit vel, tempora doloremque maiores quod quibusdam quam! Ex culpa, magni nisi ea et pariatur cumque quae odit sunt quo dicta modi ut ullam quod laborum beatae voluptatem sint, expedita unde obcaecati debitis? Beatae, libero nulla magnam earum odio sapiente ea a unde nihil quaerat quas, dolorum itaque vitae quasi excepturi? Aperiam, sequi velit.
                                </p>
                            </div>
                        </div>
                    </div>
